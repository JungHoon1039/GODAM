...
class Cat(models.Model):
      ...
      Catimage = models.ImageField(upload_to=_get_upload_to)
      ...
      User = models.ForeignKey("User.User", on_delete=models.CASCADE,db_column="user")

# Create your models here.

class Board(models.Model):
    Title = models.CharField(max_length=64, verbose_name='제목')
    Catid = models.CharField(max_length=64, verbose_name='고양이')
